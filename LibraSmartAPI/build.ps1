...
if (-not (Test-Path $frontPath)) {
    Write-Host "✗ Папка front не найдена!" -ForegroundColor Red
    exit 1
}
...
Write-Host "✓ Фронтенд скопирован" -ForegroundColor Green
Write-Host ""
...
Write-Host "✓ Бэкенд собран" -ForegroundColor Green
Write-Host ""
